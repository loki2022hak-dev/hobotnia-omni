...
export default function HobotniaDashboard() {
  ...
  const [chats, setChats] = useState<ChatThread[]>([
    {
      ...
      count: 2,
      messages: [
        { id: "m1", sender: "Toretto", text: "Здорово! Готовий виїхати сьогодні на трек?", time: "10:15" },
    ...
    },
    {
      ...
      count: 1,
      messages: [
        { id: "m4", sender: "NightRider", text: "Гоу сьогодні ввечері катнемо по набережній?", time: "10:21" }
      ]
    }
  ]);
  ...
  const handleStatSliderChange = (statName: keyof typeof stats, value: number) => {
  ...
  const handleCreateRoom = () => {
    ...
    if (balance < roomBetSelect) return;
          ...
          <div className="flex-1 p-5 overflow-y-auto space-y-5">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-5">
              ...
              <div className="xl:col-span-4 bg-gradient-to-b from-amber-950/20 to-transparent border border-amber-500/20 rounded-xl p-4 flex flex-col justify-between">
                <span className="text-[10px] font-black tracking-widest text-amber-500 uppercase block text-center">VIP GOLD МЕТРИКИ</span>
